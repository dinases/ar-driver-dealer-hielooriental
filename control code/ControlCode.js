...
var verhoeff = require('./Verhoeff.js');
var allegedRC4 = require('./AllegedRC4.js')
var mBase64SIN = require('./Base64SIN.js')

module.exports = {
  generateControlCode: function(authorizationNumber, invoiceNumber, nitci,
      ...
      //se obtiene base64
      var base64SIN = mBase64SIN.convertBase64(sumProduct);
...
function addVerhoeffDigit(value,max){
    for(i=1;i<=max;i++){
        val = verhoeff.generateVerhoeff(value);
        value += val.toString();
    }
    return value;
}
